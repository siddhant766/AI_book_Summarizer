...
import { RiUserLine, RiMailLine, RiLockPasswordLine, RiLoader4Line } from 'react-icons/ri';
      ...
      >
        <div className="glass-card rounded-3xl p-8 border border-slate-200/50 dark:border-slate-800/40 shadow-2xl relative z-10">
          ...
          <div className="text-center space-y-2 mb-8">
            <h2 className="font-display font-bold text-3xl tracking-tight dark:text-white">Create Account</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">Start summarizing books and extracting insights</p>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400 font-medium">
            ...
            <Link to="/login" className="text-brand-500 hover:text-brand-600 font-semibold underline decoration-2">
              Log in here
            </Link>
          </p>
